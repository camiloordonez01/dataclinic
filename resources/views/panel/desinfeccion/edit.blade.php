    ...
    <div class="row">
        <div class="col-md-8 mx-auto">
            <div class="card card-principal">
                ...
                @endif
                <div class="card-header">
                    <h3 class="card-title">Editar desinfección</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                {!!Form::model($desinfeccion,['method'=>'PUT','route'=>['Desinfeccion.update',$desinfeccion->id]])!!}
                {{Form::token()}}
                    <div class="card-body">
                        ...
                        <div class="row"> 
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" value="{{$desinfeccion->fecha}}" name="fecha" id="fecha" required>
                                </div>
                            </div> 
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <label for="hora">Hora</label>
                                    <input type="time" class="form-control" value="{{$desinfeccion->hora}}" name="hora" id="hora" required>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <label for="ambulancia">Ambulancia</label>
                                    <input type="text" class="form-control" value="{{$desinfeccion->ambulancia}}" name="ambulancia" placeholder="Placa de ambulancia" required>
                                </div>
                            </div>
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label for="desinfectante">Desinfectante</label>
                                    <input type="text" class="form-control" name="desinfectante" value="{{$desinfeccion->desinfectante}}" required>
                                </div>
                            </div>
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label for="motivo">Motivo Desinfeccion</label>
                                    <textarea name="motivo" class="form-control" cols="30" rows="5" required>{{$desinfeccion->motivo}}</textarea>
                                </div>
                            </div>
                        </div>
                        <hr>
                        ...
                        <div class="row">
                            <div class="col-md-6 mx-auto">
                                ...
                                <input type="hidden" name="firmaPaciente1Id" value="{{$desinfeccion->firma}}">
                                <img src="@if (!($desinfeccion->firma == '')){{ asset('files/desinfeccion/'.$desinfeccion->firma) }} @endif" id="firma1Tomada" class="w-100">
                                <hr>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer text-center d-block">
                                                ...
                                                <script>
                                                    ...
                                                    signaturePad.fromDataURL("{{ asset('files/desinfeccion/'.$desinfeccion->firma) }}", {width: 600, height: 250});
