    ...
    <div class="row">
        <div class="col-md-8 mx-auto">
            <div class="card card-principal">
                ...
                @endif
                <div class="card-header">
                    <h3 class="card-title">Registrar desinfección</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                {!!Form::open(array('url'=> 'desinfeccion/store','method'=>'POST','autocomplete'=>'off'))!!}
                {{Form::token()}}
                    <div class="card-body">
                        ...
                        <div class="row"> 
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="ambulancia" placeholder="Placa de ambulancia" required>
                                </div>
                            </div>
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label for="desinfectante">Desinfectante</label>
                                    <input type="text" class="form-control" name="desinfectante"  required>
                                </div>
                            </div>
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label for="motivo">Motivo Desinfeccion</label>
                                    <textarea name="motivo" class="form-control" cols="30" rows="5" required></textarea>
                                </div>
                            </div>
                        </div>
                        <hr>
