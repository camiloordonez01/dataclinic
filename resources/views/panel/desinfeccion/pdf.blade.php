        ...
        <div style="width: 650px; height: 792px;background-color: white; margin: auto;">
            <div style="background-color:#9bc2e6;padding: 20px 0px;color:white;">
                ...
                <div style="width:calc(100% - 75px);">
                    <h3 style="text-align: center;margin-bottom:2px;">FORMATO DE DESINFECCION AMBULANCIAS</h3>
            ...
            <table style="border-left: 1px solid black;border-top: 1px solid black; font-size:14px;margin-top: 40px;width:600px;">
                <thead>
                    <tr style="border-bottom: 1px solid black;">
                        ...
                        <th style="border-right: 1px solid black;border-bottom: 1px solid black;">DESINFECTANTE</th>
                        <th style="border-right: 1px solid black;border-bottom: 1px solid black;">MOTIVO DESINFECCION</th>
                ...
                <tbody>
                    ...
                    <tr style="border-bottom: 1px solid black;width:100%;">
                        ...
                        <td style="border-right: 1px solid black;border-bottom: 1px solid black;width:70%;">{{$dato->desinfectante}}</td>
                        <td style="border-right: 1px solid black;border-bottom: 1px solid black;width:70%;">{{$dato->motivo}}</td>
                        <td style="border-right: 1px solid black;border-bottom: 1px solid black;width:10%;text-align:center;"><img src="@if (!($dato->firma == '')){{ asset('files/desinfeccion/'.$dato->firma) }} @endif" width="100"></td>
                    </tr>
                    @endforeach
                </tbody>
            </table>
