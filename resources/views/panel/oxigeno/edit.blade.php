    ...
    <div class="row">
        <div class="col-md-8 mx-auto">
            <div class="card card-principal">
                ...
                @endif
                <div class="card-header">
                    <h3 class="card-title">Editar registro de oxigeno</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                {!!Form::model($dato,['method'=>'PUT','route'=>['Oxigeno.update',$dato->id]])!!}
                {{Form::token()}}
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" name="fecha" id="fecha" value="{{$dato->fecha}}" required>
                                </div>
                            </div>
                        </div>
                        <hr>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <select name="numeroCilindro" class="form-control" required>
                                    ...
                                    <option value="{{$cilindro->numero}}" @if($dato->numeroCilindro==$cilindro->numero){{'Selected'}} @endif>{{$cilindro->numero}}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-md-6">
                                ...
                                <select name="fugas" class="form-control" required>
                                    ...
                                    <option value="1" @if($dato->fugas=='1'){{'Selected'}} @endif>Si</option>
                                    <option value="0" @if($dato->fugas=='0'){{'Selected'}} @endif>No</option>
                                </select>
                            </div>
                            <div class="col-md-6 mt-4">
                                ...
                                <select name="abolladura" class="form-control" required>
                                    <option value="" selected disabled>Seleccione</option>
                                    <option value="1" @if($dato->abolladura=='1'){{'Selected'}} @endif>Si</option>
                                    <option value="0" @if($dato->abolladura=='0'){{'Selected'}} @endif>No</option>
                                </select>
                            </div>
                            <div class="col-md-6 mt-4">
                                ...
                                <select name="nivelAdecuado" class="form-control" required>
                                    <option value="" selected disabled>Seleccione</option>
                                    <option value="1" @if($dato->nivelAdecuado=='1'){{'Selected'}} @endif>Si</option>
                                    <option value="0" @if($dato->nivelAdecuado=='0'){{'Selected'}} @endif>No</option>
                                </select>
                            </div>
                            <div class="col-md-6 mt-4">
                                ...
                                <select name="cierreValvula" class="form-control" required>
                                    <option value="" selected disabled>Seleccione</option>
                                    <option value="1" @if($dato->cierreValvula=='1'){{'Selected'}} @endif>Si</option>
                                    <option value="0" @if($dato->cierreValvula=='0'){{'Selected'}} @endif>No</option>
                                </select>
                            </div>
                        </div>
                        <hr>
                        ...
                        <div class="row">
                            <div class="col-md-6 mx-auto">
                                ...
                                <input type="hidden" name="firmaPaciente1Id" value="{{$dato->firma}}">
                                <img src="@if (!($dato->firma == '')){{ asset('files/oxigenos/'.$dato->firma) }} @endif" id="firma1Tomada" class="w-100">
                                <hr>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer text-center d-block">
                                                ...
                                                <script>
                                                    ...
                                                    signaturePad.fromDataURL("{{ asset('files/oxigenos/'.$dato->firma) }}", {width: 600, height: 250});
