    ...
    <div class="row">
        <div class="col-md-8 mx-auto">
            <div class="card card-principal">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                {!!Form::model($desinfeccion,['method'=>'PUT','route'=>['Lavadero.update',$desinfeccion->id]])!!}
                {{Form::token()}}
                    <div class="card-body">
                        ...
                        <div class="row"> 
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="observaciones" class="form-control" cols="30" rows="5" required>{{$desinfeccion->observaciones}}</textarea>
                                </div>
                            </div>
                        </div>
                        <hr>
                        ...
                        <div class="row">
                            <div class="col-md-6 mx-auto">
                                ...
                                <img src="@if (!($desinfeccion->firma == '')){{ asset('files/lavadero/'.$desinfeccion->firma) }} @endif" id="firma1Tomada" class="w-100">
                                <hr>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer text-center d-block">
                                                ...
                                                <script>
                                                    ...
                                                    signaturePad.fromDataURL("{{ asset('files/lavadero/'.$desinfeccion->firma) }}", {width: 600, height: 250});
