    ...
    <div class="row">
        <div class="col-lg-8 col-sm-12 mx-auto">
            <div class="card card-principal">
                ...
                @endif
                <div class="card-header">
                    <h3 class="card-title">Registrar reunion</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                {!!Form::open(array('url'=> 'reuniones/store','method'=>'POST','autocomplete'=>'off'))!!}
                {{Form::token()}}
                    <div class="card-body">
                        ...
                        <div class="row"> 
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="tema" id="tema" placeholder="Escribe el tema a tratar" required>
                                </div>
                            </div>
                        </div>
                        <hr>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="observaciones" class="form-control" rows="5" required></textarea>
                                </div>
                            </div>
                            <div class="col-sm-6 col-lg-6">
                                ...
                                <input type="text" name="cedulaInstructor" placeholder="Cedula del instructor" class="form-control mt-2" required>
                                <input type="text" name="cargoInstructor" placeholder="Cargo del instructor" class="form-control mt-2 mb-2" required>
                            ...
                            <div class="col-sm-6 col-lg-6">
                                ...
                                <input type="text" name="cedulaCoordinador" placeholder="Cedula del Coordinador" class="form-control mt-2" required>
...
<script>
    ...
    $(document).ready(function(){
        ...
        $('#hora').val((((new Date().getHours()).toString().length==1)? '0'+new Date().getHours(): new Date().getHours())+":"+(((new Date().getMinutes()).toString().length==1)? '0'+new Date().getMinutes(): new Date().getMinutes()));
    });
