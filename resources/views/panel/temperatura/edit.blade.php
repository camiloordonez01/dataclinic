    ...
    <div class="row">
        <div class="col-md-8 mx-auto">
            <div class="card card-principal">
                ...
                @endif
                <div class="card-header">
                    <h3 class="card-title">Editar temperatura</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                {!!Form::model($dato,['method'=>'PUT','route'=>['Temperatura.update',$dato->id]])!!}
                {{Form::token()}}
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input type="time" class="form-control" name="hora" id="hora" value="{{$dato->hora}}" required>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <label for="jornada">Jornada</label>
                                    <input type="text" class="form-control" name="jornada" id="jornada" value="{{$dato->jornada}}" required>
                                </div>
                            </div>
                        </div>
                        <hr>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" name="temperatura" placeholder="Ingrese tempertura" value="{{$dato->temperatura}}" required>
                            </div>
                            <div class="col-md-6">
                                <label for="humedad">Humedad</label>
                                <input type="text" class="form-control" name="humedad" placeholder="Ingrese humedad" value="{{$dato->humedad}}" required>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mx-auto">
                                ...
                                <img src="@if (!($dato->firma == '')){{ asset('files/temperaturas/'.$dato->firma) }} @endif" id="firma1Tomada" class="w-100">
                                <hr>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer text-center d-block">
                                                ...
                                                <script>
                                                    ...
                                                    signaturePad.fromDataURL("{{ asset('files/temperaturas/'.$dato->firma) }}", {width: 600, height: 250});
