    ...
    <div class="row">
        <div class="col-md-8 mx-auto">
            <div class="card card-principal">
                ...
                @endif
                <div class="card-header">
                    <h3 class="card-title">Registrar temperatura</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                {!!Form::open(array('url'=> 'temperatura/store','method'=>'POST','autocomplete'=>'off'))!!}
                {{Form::token()}}
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" name="temperatura" placeholder="Ingrese tempertura" required>
                            </div>
                            <div class="col-md-6">
                                <label for="humedad">Humedad</label>
                                <input type="text" class="form-control" name="humedad" placeholder="Ingrese humedad" required>
                            </div>
                        </div>
                        <hr>
